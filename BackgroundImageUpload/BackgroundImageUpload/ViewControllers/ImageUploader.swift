...
class ImageUploader: UIViewController {
    ...
    @IBAction func btnUploadTappex(_ sender: Any) {
        ...
        //Loop through image array and save the image in document's directory you can use temp directory with which you can relinquish it when operation completed 
